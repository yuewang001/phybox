...
#define MAX_DATA_COUNT 65536
#define MAX_DEVICES		4
#define MAX_SLOTS		10
#define MAX_AI_CHANS	MAX_DATA_COUNT
#define MAX_AO_CHANS	MAX_DATA_COUNT
#define MAX_DI_CHANS	MAX_DATA_COUNT
#define MAX_DO_CHANS	MAX_DATA_COUNT
...
I16 PID_AI_GrpRead(U16 DeviceId, U16 GrpId, float *Data, U16 Count);
I16 PID_AO_GrpWrite(U16 DeviceId, U16 GrpId, float *Data, U16 Count);
I16 PID_AI_VoltScale(float *Data, F64 *Slp, F64 *Itcp, F64 *Volt, U16 Count);
I16 PID_AO_VoltScale(F64 *Volt, F64 *Slp, F64 *Itcp, float *Data, U16 Count);
...
struct enet_frame {
	U16 byte_count;
	unsigned short data[65536*6+1024];	// 46 to 1500 bytes
